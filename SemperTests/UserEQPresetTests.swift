// SemperTests/UserEQPresetTests.swift
...
struct UserEQPresetCRUDTests {
    ...
    private func makeTempManager() throws -> (SettingsManager, URL) {
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("SemperTests-\(UUID().uuidString)")
...
struct SettingsVersionTests {
    ...
    @Test("Default Settings().version is current")
    func defaultVersion() {
        let settings = SettingsManager.Settings()
        #expect(settings.version == 15)
    }
