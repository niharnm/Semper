// Semper/Audio/Keys/AccessibilityPermissionService.swift
import AppKit
...
final class AccessibilityPermissionService: AccessibilityTrustProviding {
    ...
    private let logger = Logger(subsystem: "systems.semper.Semper", category: "AccessibilityPermissionService")
