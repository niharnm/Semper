// Semper/Views/DesignSystem/DesignTokens.swift
import SwiftUI
import AppKit

/// Design System tokens for Semper UI
...
enum DesignTokens {
    ...
    enum Colors {
        ...
        /// Master slider fill while gain is above 100%.
        static let boostedSliderFill = LinearGradient(
            colors: [
        ...
        static let unityMarker: Color = .white.opacity(0.58)

        /// Dark-tinted app icon container.
        static let appIconTintBackground = Color(white: 0.13)
        static let appIconTintFill = LinearGradient(
            colors: [Color(white: 0.15), Color(white: 0.08)],
            startPoint: .topLeading,
            endPoint: .bottomTrailing
        )
        static let appIconTintBorder = Color.white.opacity(0.12)
        static let appIconTintShadow = Color.black.opacity(0.5)

        // MARK: Semper Next

        static let nextControlBackground = dynamicColor(
            name: "nextControlBackground",
            light: NSColor.black.withAlphaComponent(0.06),
            dark: NSColor.white.withAlphaComponent(0.08)
        )

        static let nextControlHover = dynamicColor(
            name: "nextControlHover",
            light: NSColor.black.withAlphaComponent(0.1),
            dark: NSColor.white.withAlphaComponent(0.16)
        )

        static let nextControlBorder = dynamicColor(
            name: "nextControlBorder",
            light: NSColor.black.withAlphaComponent(0.08),
            dark: NSColor.white.withAlphaComponent(0.08)
        )

        static let nextMasterBackground = dynamicColor(
            name: "nextMasterBackground",
            light: NSColor.black.withAlphaComponent(0.035),
            dark: NSColor.black.withAlphaComponent(0.18)
        )

        static let nextFooterBackground = dynamicColor(
            name: "nextFooterBackground",
            light: NSColor.black.withAlphaComponent(0.035),
            dark: NSColor.black.withAlphaComponent(0.2)
        )

        static let nextSectionBorder = dynamicColor(
            name: "nextSectionBorder",
            light: NSColor.black.withAlphaComponent(0.08),
            dark: NSColor.white.withAlphaComponent(0.06)
        )

        static let systemBlue = Color(red: 0.0, green: 0.478, blue: 1.0)
        static let systemGreen = Color(red: 0.188, green: 0.82, blue: 0.345)
        static let systemOrange = Color(red: 1.0, green: 0.624, blue: 0.039)
        static let systemRed = Color(red: 1.0, green: 0.271, blue: 0.227)

        static let stereoMeterFill = LinearGradient(
            colors: [systemGreen, systemOrange, systemRed],
            startPoint: .leading,
            endPoint: .trailing
        )
    ...
    enum Typography {
        ...
        static let rowName = Font.system(size: 12.5, weight: .semibold)
    ...
    enum Dimensions {
        ...
        /// Content padding
        static var contentPadding: CGFloat { Spacing.md }
        ...
        /// Row content height
        static let rowContentHeight: CGFloat = 32

        /// Output rows include a second compact balance-control line.
        static let outputDeviceRowContentHeight: CGFloat = 104
        static let outputDeviceRowCompactContentHeight: CGFloat = 76
        ...
        static let sliderMinWidth: CGFloat = 100
    ...
    enum Links {
        static let website = URL(string: "https://semper.systems")!
        static let buyMeACoffee = URL(string: "https://buymeacoffee.com/semper")!
