// Semper/Views/MenuBar/MenuBarIconCoordinator.swift
...
// was set to "Semper" by the library, and crossfade images directly.
...
final class MenuBarIconCoordinator: MediaKeyIconFlashing {
    ...
    private func resolveButton() -> NSStatusBarButton? {
        ...
        for window in NSApp.windows {
            ...
            if let button = findStatusBarButton(in: contentView, matching: "Semper") {
