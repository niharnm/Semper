// Semper/Utilities/URLHandler.swift
import Foundation
import os
...
/// Handles URL scheme actions for Semper (semper://...)
@MainActor
final class URLHandler {
    ...
    /// URL format: semper://set-volumes?app=com.a&volume=100&app=com.b&volume=50
    ...
    /// URL format: semper://step-volume?app=com.a&direction=up (or down)
    ...
    /// URL format: semper://set-mute?app=com.a&muted=true&app=com.b&muted=false
    ...
    /// URL format: semper://toggle-mute?app=com.a&app=com.b
    ...
    /// URL format: semper://reset?app=com.a&app=com.b or semper://reset (all apps)
