// Semper/Audio/Monitors/BluetoothDeviceMonitor.swift
import AppKit
import IOBluetooth
import os
...
final class BluetoothDeviceMonitor {
    ...
    private nonisolated static let btQueue = DispatchQueue(label: "systems.semper.bluetooth")
    ...
    func notifyDeviceAppearedInCoreAudio() {
        if !connectingIDs.isEmpty {
            ...
            // Auto-connected device (not via Semper) — still need to refresh
