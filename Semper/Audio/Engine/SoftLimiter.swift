...
///
/// **Behavior:**
/// - At or below -1 dBFS: passes through unchanged
/// - Above -1 dBFS: smooth compression approaching 1.0 asymptotically
/// - Never exceeds ±1.0 for any finite input
enum SoftLimiter {

    /// Linear amplitude for -1 dBFS, where limiting begins.
    static let threshold: Float = 0.891_250_9
