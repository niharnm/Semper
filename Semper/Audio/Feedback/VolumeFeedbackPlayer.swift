// Semper/Audio/Feedback/VolumeFeedbackPlayer.swift
import AppKit
import os
...
enum VolumeFeedback {
    ...
    /// The pop bypasses Semper's taps. Software-tier devices attenuate inside the taps,
...
final class VolumeFeedbackPlayer {
    ...
    private nonisolated let queue = DispatchQueue(label: "systems.semper.Semper.volume-feedback", qos: .userInitiated)
