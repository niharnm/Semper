// Semper/Audio/Extensions/AudioDeviceID+Classification.swift
import AppKit
import AudioToolbox
...
nonisolated extension AudioDeviceID {
    ...
    ///
    /// Used to *flatten* a user-created aggregate before wrapping it in Semper's own
    ...
    /// channels), so the sub-devices must be expanded into Semper's aggregate directly.
