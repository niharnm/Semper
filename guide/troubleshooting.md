...
Semper requires the **Screen & System Audio Recording** permission to capture and route app audio.

1. Open **System Settings** → **Privacy & Security** → **Screen & System Audio Recording**
2. Find Semper in the list and enable it
3. **Restart Semper** — the permission doesn't take effect until relaunch

If you previously denied the permission prompt, you'll need to enable it manually from System Settings.

## App not appearing

Semper only shows apps that are **actively playing audio**. If an app isn't visible:
...
**Per-device slider.** When you open a device, Semper picks a volume backend automatically:
...
> **Note:** For AirPods, taking them out of your ears and putting them back in (without the case) is handled by macOS Automatic Ear Detection. Semper doesn't interfere with that.

## Input devices not showing

Semper's input device monitoring requires separate microphone permission.

1. Open **System Settings** → **Privacy & Security** → **Microphone**
2. Find Semper and enable it
3. Restart Semper

## Media keys don't control Semper

Media keys (F10 / F11 / F12) are opt-in and require the **Accessibility** permission so Semper can observe the keystrokes.

1. Open **System Settings** → **Privacy & Security** → **Accessibility**
2. Enable Semper in the list. If it's already on, toggle it off and back on to clear a rare permission-bootstrap race.
3. Open Semper Settings → **Media Keys & HUD**, turn on **Control volume with media keys**, and pick a HUD style (Tahoe or Classic) or disable the HUD
...
- Try resetting the app to defaults: `open "semper://reset"` in Terminal
